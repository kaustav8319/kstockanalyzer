...
def predict(request, ticker_value, number_of_days):
    ...
    fig.update_layout(paper_bgcolor="#14151b", plot_bgcolor="#14151b", font_color="gray")
    ...
    try:
        df_ml = yf.download(tickers = ticker_value, period='1mo', interval='1h')
    except:
        ticker_value = 'AAPL'
        df_ml = yf.download(tickers = ticker_value, period='1y', interval='1m')
    ...
    pred_fig.update_layout(paper_bgcolor="#14151b", plot_bgcolor="#14151b", font_color="gray")
